...
uniform sampler2D image_texture2;
...
void main()
{
	...
	vec4 color_image_texture2 = texture(image_texture2, uv_image);

	// Compute the base color of the object based on: vertex color, uniform color, and texture
	vec3 color_object  = fragment.color * material.color * color_image_texture.rgb + 0.2*color_image_texture2.rgb;
